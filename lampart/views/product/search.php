                ...
                foreach ($datas['products'][0] as $data) { ?>
                    <tr>
                        ...
                        <td class="text-center align-middle">
                            ...
                            <a href=""><i class="fa-regular fa-copy fa-xl"></i></a>
            ...
            <nav aria-label="Page navigation example">
                ...
                <?php
                        if(isset($url[2]) && $url[2] > 1){
                            ?>
                                <li class="page-item"><a class="page-link" href="<?= URL ?>product/search/<?= $url[2] - 1 ?>">Previous</a></li>
                            <?php
                        }else{
                            ?>
                    ...
                    <?php
                        ...
                        for(  $counter = 1; $counter <= count( $datas['products'][1]); $counter++){
                            ?>
                                <li class="page-item <?= $url[2]== $counter ? 'active' : '' ?>"><a class="page-link" href="<?= URL ?>product/search/<?=$counter?>"><?=$counter?></a></li>
                            <?php
                        }
                    ...
                    if (!isset($url[2])) {
                    ?>
                        <li class="page-item"><a class="page-link" href="<?= URL ?>product/search/2">Next</a></li>
                        <?php
                    } else {
                        ...
                        ?>
                            <li class="page-item"><a class="page-link" href="<?= URL ?>product/search/<?= $url[2] + 1 ?>">Next</a></li>
                    <?php
                        }
                    }
                    ?>
